...
<body>
    ...
    <div class="search-bar">
        <form method="post">
            <input type="text" name="fn" placeholder="Search for national parks..." class="oval-input">
    ...
    <%
        ...
        if(name != null && !name.trim().isEmpty()) {
            ...
            try {
                ...
                String query = "SELECT fname, flocation, fstate, afound, farea, ftype FROM forest WHERE ftype = 'National Park' AND fname=?";
